...
const BlogDetailsPage = () => {
  ...
  return (
    <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md mx-auto mt-10 dark:bg-gray-50 dark:text-gray-800">
      {/* Author info */}
      ...
      <div>
        ...
        <p className="text-sm dark:text-gray-600 mb-2">{blog.category}</p>
        <p className="text-sm dark:text-gray-600">{blog.longDescription}</p>
      </div>
      ...
      {isOwner && (
        <button
          ...
          className="mb-6 px-4 py-2 bg-orange-500 text-white rounded cursor-pointer"
        >
          Update Blog
        </button>
      )}
