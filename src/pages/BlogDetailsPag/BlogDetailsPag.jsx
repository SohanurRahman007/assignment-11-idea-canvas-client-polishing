...
const BlogDetailsPage = () => {
  ...
  const [likes, setLikes] = useState(0); // Initialize with a default value
  const [userLiked, setUserLiked] = useState(false); // Initialize with a default value
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [id, user]); // Add user to the dependency array to re-run when the user object changes
